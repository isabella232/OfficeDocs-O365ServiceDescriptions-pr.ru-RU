...
При использовании многофакторной проверки подлинности для Office 365\* после ввода правильного пароля пользователь должен ответить на телефонный звонок, принять SMS или уведомление в приложении на своем смартфоне. Пользователь сможет войти только после прохождения второго этапа аутентификации. Администраторы Office 365 могут регистрировать пользователей для многофакторной проверки подлинности в центре администрирования Microsoft 365. Узнайте больше о [многофакторной проверке подлинности в Office 365](https://go.microsoft.com/fwlink/p/?LinkId=392429).
