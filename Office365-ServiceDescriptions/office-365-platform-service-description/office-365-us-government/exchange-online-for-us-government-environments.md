...
## <a name="feature-nuances-within-gcc-environments"></a>Особенности функций в средах GCC
...
|Миграция Wunderlist|Разрешить пользователям Wunderlist переносить данные в задачу|Да|Нет|
