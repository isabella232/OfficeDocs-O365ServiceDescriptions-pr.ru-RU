...
|**[Политика обработки сообщений и соответствие требованиям](../../exchange-online-service-description/message-policy-and-compliance.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
|**[Защита от нежелательной почты и вредоносных программ](../../exchange-online-service-description/anti-spam-and-anti-malware-protection.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
|Microsoft Defender для Office 365|Да|Да|Да|Требуется план обслуживания G5 (или приобрести надстройку).<br><br>Защита от фишинга для олицетворения пользователя и домена и логики подмены пока недоступна в GCC High и DoD.|
|**[Поток обработки почты](../../exchange-online-service-description/mail-flow.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
|**[Получатели](../../exchange-online-service-description/recipients.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
|**[Функции создания отчетов и средства устранения неполадок](../../exchange-online-service-description/reporting-features-and-troubleshooting-tools.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
|**[Общий доступ и совместная работа](../../exchange-online-service-description/sharing-and-collaboration.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
|**[Клиенты и мобильные устройства](../../exchange-online-service-description/clients-and-mobile-devices.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
|Выполнение в Интернете|Да|Нет|Нет||
...
|**[Службы голосовых сообщений](../../exchange-online-service-description/voice-message-services.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
|**[Высокая доступность и непрерывность бизнес-процессов](../../exchange-online-service-description/high-availability-and-business-continuity.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
|**[Взаимодействие, связь и совместимость](../../exchange-online-service-description/interoperability-connectivity-and-compatibility.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
|**[Установка и администрирование Exchange Online](../../exchange-online-service-description/exchange-online-setup-and-administration.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
|**[Расширение настройки службы, надстроек и ресурсов](../../exchange-online-service-description/exchange-online-service-description.md)**|**GCC**|**GCC High**|**DoD**|**Ключевые моменты**|
...
Если вы планируете использовать шифрование сообщений Office 365 в среде высокой загрузки GCC, учитывайте следующие уникальные характеристики взаимодействия с получателем:  
...
## <a name="feature-nuances-within-gcc-environments-for-microsoft-to-do"></a>Особенности функций в средах GCC для Майкрософт

| Возможность | Описание | НН | Доступность в GCC |
|:-----|:-----|:-----|:-----|
|Поддерживаемые платформы|Интернет, Android, iOS, Mac, Windows|Все|Только веб-|
|Концентратор M365 поддерживает|Интеграция с Outlook, Teams, планировщик|Все|Outlook, планировщик (Teams должен быть доступен в приложении "задачи Teams")|
|Миграция Wunderlist|Разрешить пользователям Wunderlist переносить данные в веб-сайт|Да|Нет|
|Push-уведомления|Отправлять push-уведомления конечным пользователям для напоминаний и т. д.|Да|Нет|
|Поддержка хелпшифт|Создание запроса на поддержку с помощью интерфейса хелпшифт|Да|Нет|
|Мой день|Планирование дня|Да|Да|
|Запланированный список|Просмотр всех задач с сроком выполнения|Да|Да|
|Список назначенных вам|Все задачи, назначенные вам в общем списке, планировщике или ВКСП (будущее)|Да|Да|
|Помеченные сообщения электронной почты|Просмотр сообщений, помеченных в Outlook как задачи|Да|Да|
|Поддержка нескольких учетных записей|Использование домашней и офисной учетной записи в одной области|Да|Да|
|Общий доступ к спискам|Совместное использование списков с коллегами в одной и той же Организации|Да|Да|
|Совместное использование нескольких клиентов|Общий доступ к списку задач за прев Организации|Да|Нет|
|Напоминания и повторение|Настройка напоминаний для задачи |Да|Да|

* Все другие неупомянутые функции доступны в обеих средах.
