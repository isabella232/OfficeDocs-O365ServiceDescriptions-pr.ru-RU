...
Клиенты, использующие SharePoint Online и OneDrive для бизнеса в средах GCC High и DoD, могут сохранять конфиденциальность документов (первый вариант) либо делать их доступными всем пользователям в организации (второй вариант), всем пользователям со ссылкой на документ (третий вариант) или определенным пользователям в средах GCC High и DoD (четвертый вариант). Конечно, эти варианты также можно ограничивать путем управления доступом на уровне клиента.
