...
- Клиент C, отличный от GCC, может обмениваться данными с большим клиентским клиентом A или B, а пользователи A или B — входить в систему с помощью одноразовых секретных кодов.
