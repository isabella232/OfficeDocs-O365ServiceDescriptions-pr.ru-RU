...
Пользователи имеют несколько вариантов предоставления общего доступа к файлам и папкам в SharePoint и OneDrive. Все параметры доступны в средах GCC High и DoD. Чтобы узнать об управлении этими параметрами, ознакомьтесь со статьей [Управление параметрами общего доступа](/sharepoint/turn-external-sharing-on-or-off). Когда пользователи совместно используются с параметром "определенные пользователи" и выбирают людей за прев Организации, SharePoint обычно отправляет проверочный код в электронную почту. Получателям потребуется ввести код для доступа к общему элементу. Это справедливо, когда пользователи в более высоких организациях GCC совместно используют людей в других организациях без GCC и наоборот. (Более подробную информацию о внешнем общем доступе можно узнать в разделе [что происходит при общем](/sharepoint/external-sharing-overview#what-happens-when-users-share)доступе пользователей). Тем не менее, если пользователь в одной организации, сопоставленной с людьми в другой организации, использует учетную запись гостя для получателя в Azure AD, будет выполняться вход с использованием имени пользователя и пароля. 
