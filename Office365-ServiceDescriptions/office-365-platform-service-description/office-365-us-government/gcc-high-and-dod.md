 ...
 **Изолированные решения.** Эта функция устарела и недоступна. Все изолированные решения следует перенести в [модель расширения надстроек SharePoint]( https://msdn.microsoft.com/library/office/fp179930.aspx).
