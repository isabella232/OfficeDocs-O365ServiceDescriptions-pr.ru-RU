...
ms.locfileid: "60462170"
---
# <a name="office-365-germany"></a>Office 365 Germany

Office 365 Германия — это дифференцированный вариант от тех Office 365, которые уже доступны в Европе. Это помогает решать потребности наиболее регулируемых клиентов в Германии, Европейском союзе (ЕС) и Европейской ассоциации свободной торговли (EFTA), доставляя наши передовые в отрасли службы производительности для цифровой работы, из немецких центров обработки данных, с проживанием данных в Германии и строгими мерами доступа к данным и мерами контроля с помощью уникальной модели доверия к данным, управляемой в соответствии с немецким законодательством.
...
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
|Office 365 <sup>1</sup>|Да|Да|Да|Да|Да|Да|Да|Да|
...
|Visio <sup>веб-4</sup>|Да|Да|Да|Да|Да|Да|Да|Да|
...
Центр соответствия &amp; требованиям безопасности доступен для Office 365 Германии. Дополнительные сведения и список функций см. в Office 365 [Центре соответствия &amp; требованиям безопасности.](office-365-securitycompliance-center.md)

### <a name="what-compliance-certificates-are-provided-for-office-365-germany"></a>Какие сертификаты соответствия предоставляются Office 365 Германии?

Office 365 Германия придерживается стандартов облачной безопасности и соответствия требованиям Office 365. Office 365 предоставляет полный набор сертификатов, независимо оцениваемого аккредитованными аудиторами в рамках управления организацией служб (SOC), Международной организации по стандартизации (ISO) и аудитов. Сертификаты включают ISO 27001/27002, 27017, 27018 и SOC 1 и 2. Дополнительная проверка доверенных компаний, контролирующих доступ к данным Office 365 Germany, будет проведена во время ежегодных проверок ISO и SOC.
...
|Office 365 Видео[(снято)](/stream/migrate-from-office-365)|Нет|Нет|Нет|Да|Да|Да|Да|Нет|
...
|Создание собственных отчетов с Microsoft 365 веб-служб.|Да|Да|Да|Да|Да|Да|Да|Да|
...
> [!NOTE]
> <sup>1</sup> Office 365 не обеспечивает поддержку любой операционной системы, которая не поддерживается ее производителем.<br/>
<sup>2</sup> Azure Information Protection не включена, но может быть приобретена в качестве отдельной надстройки и будет включать поддерживаемые функции управления правами на информацию (IRM). Некоторые функции Azure Information Protection требуют подписки на Office 365 профессиональный плюс, которая не включена в Office 365 Germany Business Essentials, Office 365 Germany Business Premium, Office 365 Германии Enterprise E1, Office 365 Germany Education A1 или Office 365 Германии Enterprise K1.<br/>
...
|[Windows 10 Приложения](../office-applications-service-description/office-applications.md#windows-10-apps)|Да|Да|Да|Да|Да|Да|Да|Нет|
...
|**Enterprise**|**Office 365 Germany бизнес**|**Office 365 Germany бизнес базовый**|**Office 365 Germany бизнес премиум**|**Office 365 Germany для образования A1**|**Office 365 Germany корпоративный E1**|**Office 365 Germany корпоративный E3**|**Office 365 Germany корпоративный E4**|**Office 365 Germany корпоративный K1**|
...
<sup>5</sup> Если у Office профессиональный плюс 2013 г. или автономная версия Excel 2013 г., вы можете скачать и использовать предварительный просмотр power [Map для Excel 2013](https://go.microsoft.com/fwlink/p/?LinkID=397382&amp;clcid=0x409) г. в качестве неподдержаемой надстройки. <br/>
...
<sup>10</sup> Доступ в настоящее время доступен, если вы на текущем канале или на целевом выпуске для отложенного канала. Если вы на отложенных каналах, доступ будет доступен в июне 2017 года. Дополнительные сведения см. в [том, что access](https://support.office.com/article/f55c8362-5816-4f8b-897d-0a05e7ba0fef)включен в Office 365 бизнес-Premium.<br/>
...
|[Windows 10 Приложения](../office-applications-service-description/office-applications.md#windows-10-apps)|Да|Да|Да|
...
|**Enterprise**|**Office профессиональный плюс 2013**|**Office профессиональный плюс 2016**|**Office 365 профессиональный плюс**|
...
> <sup>1</sup> Office 365 Германии включают клиентские программные приложения, которые устанавливаются и запускаются на устройстве конечных пользователей ("клиентские программные приложения"), такие как Office 365 профессиональный плюс, Office 2013 г. и Office 2016 г. Клиентские программные приложения не работают исключительно в немецких центрах обработки данных и могут позволить конечному пользователю получать доступ к сетевым службам, которые не являются немецкими online services. В рамках соглашения с корпорацией Майкрософт клиентские приложения не относятся к German Online Services. Обязательства по размещению данных в Германии и контроль доступа немецким куратором относятся только к German Online Services.<br/>
<sup>2</sup> Office 2013 требуется включить современную [проверку подлинности.](https://support.office.com/article/776c0036-66fd-41cb-8928-5495c0f9168a)<br/>
<sup>3</sup> Функции архива и соответствия требованиям поддерживаются в этой версии Office, но планы Exchange Online и SharePoint Online не включены и должны быть приобретены отдельно или использоваться с поддерживаемой локальной серверной эквивалентной.<br/> <sup>4</sup> Защита информации Azure не включена, но ее можно приобрести в качестве отдельной надстройки, чтобы включить поддерживаемые функции IRM.<br/> <sup>5</sup> Windows Server AD RMS — это локальное сервер, которое необходимо приобрести и управлять отдельно, чтобы включить поддерживаемые функции IRM.<br/>
<sup>6</sup> Если у вас Office профессиональный плюс 2013 г. или автономная версия Excel 2013 г., вы можете скачать и использовать предварительный просмотр power [Map для Excel 2013](https://go.microsoft.com/fwlink/p/?LinkID=397382&amp;clcid=0x409) г. в качестве неподдержаемой надстройки.<br/>
...
|IRM с Windows Server AD RMS<sup>3</sup>|No<sup>5</sup>|No<sup>5</sup>|No<sup>5</sup>|No<sup>5</sup>|No<sup>5</sup>|No<sup>5</sup>|No<sup>5</sup>|No<sup>5</sup>|
|Office 365 шифрования сообщений|No<sup>4</sup>|No<sup>4</sup>|No<sup>4</sup>|No<sup>4</sup>|No<sup>4</sup>|Да|Да|No<sup>4</sup>|
...
|Отчеты в Центре администрирования Microsoft 365|Да|Да|Да|Да|Да|Да|Да|Да|
...
|Skype для бизнеса oWA<sup>3</sup> и Outlook|Нет|Нет|Нет|Нет|Нет|Нет|Нет|Нет|
...
|Outlook надстройки и Outlook MAPI|Да<sup>16</sup>|Да<sup>16</sup>|Да<sup>16</sup>|Да<sup>16</sup>|Да<sup>16</sup>|Да<sup>16</sup>|Да<sup>16</sup>|Нет|

> [!NOTE]
> <sup>1</sup> Exchange 2010 поддерживает только минимальное гибридное развертывание. (Полное гибридное развертывание не поддерживается Exchange 2010 г.). Дополнительные сведения о минимальном гибридном развертывании см. в сообщении Использование экспресс-миграции для переноса Exchange почтовых [ящиков в Office 365.](https://support.office.com/article/fdecceed-0702-4af3-85be-f2a0013937ef)<br/>
<sup>2</sup> Office 365 Германии Бизнес Essentials и Office 365 германии Premium не предоставляют права доступа для использования с локального сервера. Согласно правилам клиент должен приобрести соответствующие лицензии CAL или перейти на корпоративный план, который предоставляет эти права доступа.<br/>
<sup>3</sup> Не доступен для Office 365 Германии, но скоро.<br/>
<sup>4</sup> Защита информации Azure не включена, но может быть приобретена в качестве отдельной надстройки (или добавлена бесплатно в план Office 365 Образования Германии A1), чтобы включить поддерживаемые функции IRM. шифрование сообщений Office 365 зависит от Azure Information Protection.<br/>
...
<sup>8</sup> Эта функция доступна Exchange Server 2013 Пакет обновления 1 (SP1), почтовые ящики которых фильтруются EOP, и скоро будет доступна Exchange Online клиентам. <br/>
...
<sup>11</sup> Exchange Enterprise cal с клиентами Службы должны установить книгу, выбрав Exchange Online службу, а не **Exchange Online Protection** службу. <br/>
...
<sup>15</sup> Гибридная настройка недоступна с помощью гибридного мастера, но может быть настроена вручную, если Exchange SP1.<br/>
<sup>16</sup> Доступно в Office 365 Германии E1 и выше.<br/>
<sup>17</sup> Доступно в Office 365 Германии E3.<br/>
<sup>18</sup> Доступно в качестве надстройки для Office 365 Германии.

## <a name="defender-for-office-365-features"></a>Defender для Office 365 функций
...
|Развертывание приложений: SharePoint-размещены приложения|Да|Да|Да|Да|Да|Да|Да|Да|
...
|SharePoint центра администрирования (Office 365)|Да|Да|Да|Да|Да|Да|Да|No<sup>4</sup>|
...
|Аудит &amp; отчетов (например, редактирование doc, изменение политики, удаление|Да|Да|Да|Да|Да|Да|Да|Да|
...
|SharePoint службы перевода|Да|Нет|Да|Да|Да|Да|Да|Да|
...
|Visio<sup>веб-18</sup>|Да|Да|Да|Да|Да|Да|Да|Да|
...
|Гибридные OneDrive для бизнеса и сайты|Да|Да|Да|Да|Да|Да|Да|Да<sup>19</sup>|
...
|SharePoint лента|Да|Нет|Да|Да|Да|Да|Да|Да|
...
|Веб-канал (классический сайт группы с SharePoint social)|Да|Нет|Да|Да|Да|Да|Да|Да|
...
> [!NOTE]
> <sup>1</sup> Чтобы использовать синхронизацию папок, необходимо иметь Office 2013 или более поздней версии (standard или Professional edition) или подписку, которая включает Office приложений. Планы Office 365 Germany бизнес базовый, Office 365 Germany корпоративный E1 и Office 365 Germany для образования A1 не включают подписки на классические приложения Office. Но вы можете синхронизировать папки, если установите Office 2013 (или более новой версии) и подпишетесь на один из этих планов.<br/>
...
<sup>3</sup> Защита информации Azure не включена, но ее можно приобрести в качестве отдельной надстройки, чтобы включить поддерживаемые функции IRM. Чтобы создать защищенный контент RMS, необходимо иметь Office профессиональный плюс 2013, Office профессиональный плюс 2016, Приложения Microsoft 365 или Outlook веб-доступ.<br/>
...
<sup>5</sup> SharePoint клиенты Online должны скачать и установить бесплатное приложение для настройки модели ранжирования, чтобы создать и настроить модели ранжирования.<br/>
...
<sup>15</sup> Access 2010 не поддерживается.<br/> <sup>16</sup> Пользователи с базовой подпиской не могут создавать документы Office с помощью живых плиток. Чтобы создать документ, пользователи киосков должны сделать это с сайта  SharePoint Online, выбрав новый, а затем выбрав тип файла — документ Word, книгу Excel, PowerPoint презентацию, OneNote блокнот или Excel опрос — из меню Создание нового **файла.** <br/>
<sup>17</sup> форм InfoPath, содержащих код пользователя (песочницу), можно использовать только в InfoPath Rich Client.<br/>
<sup>18</sup> Visio для веб-потребления (возможности просмотра) доступны бесплатно. Visio для веб-возможностей создания и редактирования требуется лицензия. Дополнительные сведения о Visio веб-сайте см. в Visio [описании веб-службы.](../visio-online-service-description/visio-online-service-description.md)<br/>
<sup>19</sup> пользователей K1 могут получить доступ SharePoint Server в гибридной настройке, но Office 365 K1 не включает права cal для доступа к серверу; эти права должны быть приобретены отдельно.
...
|OneNote общий доступ|Да|Да|Да|Да|Да|Да|Нет|
|Ad hoc and schedule web conferencing|Да|Да|Да|Да|Да|Да|Нет|
|Skype для бизнеса собрания с помощью аудиоконференций (первая сторона)|Нет|Нет|Нет|Нет|Нет|Нет|Нет|
|Skype для бизнеса собрания через сертифицированного поставщика аудиоконференций (ACP)|No<sup>6</sup>|No<sup>6</sup>|No<sup>6</sup>|No<sup>6</sup>|No<sup>6</sup>|No<sup>6</sup>|Нет|
|PowerPoint общий доступ|Да|Да|Да|Да|Да|Да|Нет|
|Передача файлов|Да|Да|Да|Да|Да|Да|Нет|
|Доска и аннотации|Да|Да|Да|Да|Да|Да|Нет|
|PowerPoint загрузки|Да|Да|Да|Да|Да|Да|Нет|
...
|Гостевой доступ к Skype собраниям с Skype для бизнеса Web App|Да|Да|Да|Да|Да|Да|Нет|
...
|Поиск навыков SharePoint Online|Нет|Нет|Нет|Нет|Нет|Нет|Нет|
...
Visio веб-сайт доступен для Office 365 Германии. Дополнительные сведения о Visio веб-сайте см. в Visio [описании веб-службы.](../visio-online-service-description/visio-online-service-description.md)
