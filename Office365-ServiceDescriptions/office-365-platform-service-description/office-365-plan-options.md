...
Microsoft Office 365 будет доступна в различных планах для максимального соответствия потребностям вашей организации.
...
В следующей таблице приведены различные семьи служб и планы, в которых доступен Office 365:. Чтобы получить детальный обзор функций и информацию о стоимости или пообщаться с онлайн представителем, щелкните любую ссылку в столбце планов.
...
|||||||||
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
|**Служба** <br/> |**Office 365 бизнес базовый** <br/> |**Office 365 бизнес** <br/> |**Office 365 бизнес премиум** <br/> |**Office 365 корпоративный E1** <br/> |**Office 365 корпоративный E3** <br/> |**Office 365 корпоративный E5<sup>4</sup>** <br/> |**Office 365 корпоративный F1** <br/> |
|Платформа Office 365  <br/> |Да  <br/> |Нет  <br/> |Да  <br/> |Да  <br/> |Да  <br/> |Да  <br/> |Да  <br/> |
|Exchange Online  <br/> |Да,<sup>6</sup> <br/> |Нет  <br/> |Yes<sup>6</sup> <br/> |Да,<sup>6</sup> <br/> |Yes<sup>7</sup> <br/> |Да,<sup>7</sup> <br/> |Yes<sup>9</sup> <br/> |
...
|Скайп для бизнеса Online <sup>15</sup> <br/> |Да,<sup>10</sup> <br/> |Нет  <br/> |Да<sup>10</sup> <br/> |Да,<sup>10</sup> <br/> |Yes<sup>11</sup> <br/> |Да,<sup>13</sup> <br/> |Yes<sup>14</sup> <br/> |
...
|Yammer корпоративный  <br/> |Да  <br/> |Нет  <br/> |Да  <br/> |Да  <br/> |Да  <br/> |Да  <br/> |Да  <br/> |
|Сведения о Azure защиты<sup>3</sup> <br/> |Нет<sup>2</sup> <br/> |Нет  <br/> |Нет<sup>2</sup> <br/> |Нет<sup>2</sup> <br/> |Да  <br/> |Да  <br/> |Нет<sup>2</sup> <br/> |
   
> <sup>1</sup> project Online не включена, но можно приобрести в виде отдельной надстройки или бесплатно добавляемого плана обучения Office 365. > 
<br/><sup>2</sup> защита информации azure не включена, но можно приобрести в виде отдельной надстройки и будет поддержки функций управления правами на доступ к данным (IRM). Некоторые функции защиты информации Azure требуется подписка на Office 365 профессиональный плюс, которая не включена в Office 365 Business Essentials, Office 365 бизнеса расширенный, Office 365 корпоративный E1, Office 365 Education или Office 365 корпоративный F1. ><br/><sup>3</sup> чтобы узнать больше о том, какие функции защиты информации Azure включены в планы Office 365, видеть [Защита информации Azure](https://technet.microsoft.com/en-us/dn858608). > <br/><sup>4</sup> office 365 корпоративный E5 содержит возможности телефонной системой, звук конференц-связи и вызов планирование. Реализация плана вызов требуется дополнительное планирование покупки (Россия или международный). ><br/><sup>5</sup> включает в себя хранения 2 ГБ. Не включает синхронизацию с настольным ПК функциональные возможности. ><br/><sup>6</sup> Включает Exchange Online (план 1). > 
<br/><sup>7</sup> Включает Exchange Online (план 2). > 
<br/><sup>8</sup> Включает Exchange Online (план 1) и дополнительные функции. > 
<br/><sup>9</sup> Включает базовую подписку на Exchange Online. > 
<br/><sup>10</sup> Включает Skype для бизнеса Online (план 2) с ограничениями базового клиента. > <br/><sup>11</sup> Включает Skype для бизнеса Online (план 2) без ограничений клиента. > <br/><sup>12</sup> Включает Skype для бизнеса Online (план 1) и дополнительные функции. > <br/><sup>13</sup> Включает Skype для бизнеса Online (план 2) с поддержкой голосовой связи и без ограничений клиента. > 
<br/><sup>14</sup> Включает Skype для бизнеса Online (план 1). 
<br><sup>15</sup> группами Майкрософт является теперь основной клиент для обмена сообщениями, собраний и вызов в Office 365. Запуск 1 октября 2018, новых клиентов Office 365 на 500 рабочих мест или меньше будет onboarded для групп Майкрософт и не смогут получить доступ к Скайп для бизнеса в Интернет. Клиенты, которые уже используют Скайп для бизнеса в Интернет сможете продолжить это Да (включая подготовки новых пользователей) до их завершения их перехода на группами Майкрософт.
...
Сведения об изменении подписок, в том числе о переходе от пробной к платной подписке, см. в разделе [Переключение на другой план или подписку на Office 365](https://go.microsoft.com/fwlink/p/?LinkId=294642).
...
Указанные ниже веб-службы доступны в качестве отдельных планов. Их также можно добавлять в планы семейств корпоративных служб и служб для бизнеса (если их там нет). Чтобы получить информацию о стоимости или пообщаться с онлайн-представителем, щелкните любой план, указанный в следующей таблице.
