...
API службы связи службы Office 365 позволяет вам получать доступ к сервисным подключениям нужным образом. С помощью этого нового средства администрирования вы можете создавать средства и подключать их к службам связи, что может упростить процесс наблюдения за вашей средой. API службы связи службы позволяет отслеживать следующее в вашей среде:
...
Дополнительные сведения можно найти в новой записи в блоге по [средствам администрирования](https://www.microsoft.com/en-us/microsoft-365/blog/2014/07/29/new-office-365-admin-tools/) . 
