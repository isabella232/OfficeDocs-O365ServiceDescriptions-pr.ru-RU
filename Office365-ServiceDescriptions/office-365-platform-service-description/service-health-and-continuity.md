...
При возникновении инцидента службы, Майкрософт осознает, что для клиентов наиболее важна своевременная, целевая и точная информация. Корпорация Майкрософт извещет администраторов, обновив информационную панель службы для клиента (SHD) Microsoft 365 центре администрирования. Обновления инцидентов службы предоставляются почасовую каденцию или, если требуется другая каденция, она будет указано в сообщении сообщения SHD. 
