...
API службы связи службы Office 365 позволяет вам получать доступ к сервисным подключениям нужным образом. С помощью этого API вы можете создавать средства и подключать их к службам связи, что может упростить процесс наблюдения за вашей средой. API службы связи службы позволяет отслеживать следующее в вашей среде:
...
Просмотреть сведения о доступности функций в планах можно в статье [Описание службы платформы Office 365](office-365-platform-service-description.md).
