...
ATP включена в Office 365 корпоративный, Office 365 для образования A5 и Microsoft 365 бизнес премиум.
...
Чтобы сравнить функции в планах, ознакомьтесь со статьей [Сравнение приложений microsoft 365 для бизнес-планов](https://go.microsoft.com/fwlink/?LinkID=799177&amp;clcid=0x409) и [обнаружения корпоративного решения Microsoft 365, которое подходит для вас](https://www.microsoft.com/microsoft-365/compare-all-microsoft-365-plans).
