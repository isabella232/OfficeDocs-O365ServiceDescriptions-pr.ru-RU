...
|Безопасные ссылки в Teams|Нет|Нет|Нет|
...
|Автоматизированное реагирование на инциденты|Нет|Да|Да|
