...
Защитник Office 365 (план 2) входит в состав Office 365 E5, Office 365 A5 и Microsoft 365 E5. Защитник Office 365 (план 1) входит в состав Microsoft 365 бизнес премиум.
...
|*Интеграция с Microsoft 365 Defender*|Нет|Да|Да|

> [!TIP]
> Хотите получить загружаемый список различий между Защитником для Office 365 (план 1) и планом 2( [Получите PDF-файл.](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/office-365-atp-plan-comparison-march-2020.pdf)

> [!NOTE]
> Если у вашего клиента есть только пробная лицензия Office ATP P2 или пробная лицензия Office 365 E5 без другой лицензии, подходящей для защиты от угроз (Майкрософт), вы не сможете получить доступ к службе Защиты от угроз (Майкрософт). Дополнительные информацию о лицензии MTP см. в <https://docs.microsoft.com/microsoft-365/security/mtp/prerequisites>
