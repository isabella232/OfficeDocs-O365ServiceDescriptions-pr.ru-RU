...
ms.locfileid: "65218145"
---
# <a name="plan-for-microsoft-purview-compliance-and-risk-management-solutions--gcc-high-deployments"></a>Планирование решений управления рисками и соответствием требованиям Microsoft Purview — развертывания GCC High
...
## <a name="step-2-apply-for-microsoft-365-government--gcc-high"></a>Этап 2. Подайте заявку Microsoft 365 для государственных организаций — GCC-High
...
| Область | Функция | GCC высокого состояния |
|------|---------|-----------------|
| **Защита данных** |  |  |
