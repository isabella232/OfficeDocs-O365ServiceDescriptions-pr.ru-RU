...
| | Автоматическая классификация и маркировка приложений Office (Word, Excel, PowerPoint, Outlook) на разных платформах (Web, Android, iOS, Windows и Mac)  | Доступно  |
...
| | Непрерывные оценки соответствия требованиям | Развертывание |
| | Встроенные оценки для ресурсов, не Microsoft 365 ресурсов | Доступно |
| | Рекомендуемый механизм для создания массовой оценки | В разработке |
