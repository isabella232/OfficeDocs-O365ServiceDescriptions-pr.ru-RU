...
ms.locfileid: "65187460"
---
# <a name="plan-for-microsoft-purview-compliance-and-risk-management-solutions---dod-deployments"></a>Планирование решений управления рисками и соответствием требованиям Microsoft Purview — развертывания DoD
...
Дополнительные сведения о предложении Microsoft 365 DoD для государственных организаций США см. в Office 365 для государственных организаций планах[, включая](https://products.office.com/government/compare-office-365-government-plans) требования к соответствию требованиям.
...
| | PDF-файлы, зашифрованные с помощью метки конфиденциальности, можно искать и обнаруживая электронные данные | В невыполненной работе по проектированию |
...
| | Улучшения пользовательского интерфейса обозревателя действий | В разработке |
...
| | Применение действия метки хранения по истечении срока хранения  | В невыполненной работе по проектированию |
...
| | Типы конфиденциальной информации на отчет о расположении  | Доступно |
...
| | Интеграция Power Automate | В разработке |
