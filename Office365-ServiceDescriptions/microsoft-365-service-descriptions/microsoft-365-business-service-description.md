...
<sup>7</sup> Microsoft 365 поставляется с планом Office 365 Advanced Threat protection (план 1). Дополнительные сведения можно найти в [статье Microsoft 365 Business Premium Security and соответствие требованиям](https://docs.microsoft.com/microsoft-365/business/security-features).<br/>
