...
- Отображение состояния&mdash;присутствия например, "доступно", "нет", "не беспокоить"&mdash;или "не в сети", чтобы сообщить другим пользователям о доступности. Сведения о присутствии Skype для бизнеса представлены во всем наборе.
