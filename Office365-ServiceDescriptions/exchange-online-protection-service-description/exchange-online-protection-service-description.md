...
- **В изолированном сценарии** EOP предоставляет облачную защиту электронной почты для локальной среды Exchange Server 2013, устаревших версий Exchange Server или для любого другого локального решения электронной почты SMTP. 
...
Сведения о новых функциях в EOP см. в статье [Что нового в Exchange Online Protection](https://docs.microsoft.com/office365/SecurityCompliance/eop/exchange-online-protection-overview). Сравнение функций FOPE и EOP см. в статье [Сравнение функций FOPE и EOP](https://go.microsoft.com/fwlink/p/?LinkId=320391).
...
|**План**|**Описание**|
|:-----|:-----|
|[Отдельная служба EOP](https://docs.microsoft.com/office365/securitycompliance/eop/exchange-online-protection-overview) <br/> |EOP защищает ваши локальные почтовые ящики;  <br/> |
|[Функции EOP в Exchange Online](https://products.office.com/exchange/compare-microsoft-exchange-online-plans) <br/> |EOP защищает ваши почтовые ящики, размещенные в облаке Exchange Online;  <br/> |
|[Лицензия Exchange Enterprise CAL with Services](https://products.office.com/exchange/microsoft-exchange-licensing-faq-email-for-business) <br/> |EOP защищает ваши локальные почтовые ящики, как изолированная EOP, а также включает защиту от потери данных (DLP) и отправку отчетов с помощью веб-служб.  <br/> |
...
Дополнительные сведения о лицензиях Exchange Enterprise CAL with Services см. в разделе [Лицензирование Exchange Server 2013](https://products.office.com/exchange/microsoft-exchange-licensing-faq-email-for-business).
  
Если у вас есть лицензии Exchange Enterprise CAL with Services и вы хотите подготовить службу, следуйте инструкциям в статье [Настройка службы EOP](https://docs.microsoft.com/office365/SecurityCompliance/eop/set-up-your-eop-service). Действия по настройке такие же, как при настройке отдельной службы EOP.
...
EOP можно использовать с любым агентом пересылки почты SMTP, например Microsoft Exchange Server 2013. Сведения о поддерживаемых EOP операционных системах, веб-браузерах и языках см. в подразделах "Поддерживаемые браузеры" и "Поддерживаемые языки" статьи [Центр администрирования Exchange в Exchange Online Protection](https://docs.microsoft.com/office365/securitycompliance/exchange-admin-center-in-exchange-online-protection-eop).
