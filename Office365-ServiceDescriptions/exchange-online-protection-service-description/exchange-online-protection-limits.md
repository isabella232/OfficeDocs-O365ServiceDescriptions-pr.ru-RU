...
- **Допустимо ограничение домена** . Вы можете добавить до 900 принятых доменов на одного клиента. Subdomains можно включить в это ограничение 900 или, если необходимо, в составе параметра catch-all, соответствовать поддоменам. Дополнительные сведения см. в [руб. Управление принятыми доменами в EOP](/microsoft-365/security/office-365-security/exchange-online-protection-overview).
...
- **Ограничения для** отчетов и трассировки сообщений . Ограничения для отчетов и трассировки сообщений см. в разделе "Доступность и задержка отчетов и отслеживание сообщений" в разделе Отчеты и трассировка сообщений в [Exchange Online Protection](/microsoft-365/security/office-365-security/reporting-and-message-trace-in-exchange-online-protection).
