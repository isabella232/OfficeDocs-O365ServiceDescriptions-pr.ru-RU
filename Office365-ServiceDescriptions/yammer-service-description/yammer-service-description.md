...
Yammer входит в состав Office 365 и соответствует [политике управления изменениями Office 365](https://www.microsoft.com/en-us/microsoft-365/blog/2015/05/05/manage-change-and-stay-informed-in-office-365/), но не использует целевой выпуск для развертывания обновлений. 
...
|||
|:-----|:-----|
|**Изменения, требующие действия (планирование изменения)** <br/>Администратору требуется внести изменения, чтобы обеспечить работу службы, обновления, которые могут повлиять на соответствие вашей организации  <br/> |— Сообщения центра сообщений Office 365, адресованные администраторам, проверенным Yammer <br/>— План Office 365<br/>— Обновления службы Yammer<br/>— Внешняя группа<br/>Если изменения затрагивают определенное множество пользователей, мы можем также напрямую их уведомить. |
|**Изменения, требующие информирования (Оставайтесь в курсе)**<br/>Изменения, не требующие вмешательства администратора, изменения визуального дизайна  <br/> |— Центр сообщений Office 365<br/>— План Office 365<br/>— Обновления службы Yammer<br/>— Внешняя группа<br/>Если изменения затрагивают определенное множество пользователей, мы можем также напрямую их уведомить. |
