...
Для системных требований к Office 365, ежемесячной службе на основе подписки, доступной для бизнеса, образования и государственных организаций, см. в веб-сайте [Microsoft 365 и Office Resources.](https://products.office.com/office-system-requirements/#Office365forBEG)
...
|[Yammer корпоративный](https://www.microsoft.com/microsoft-365/yammer/yammer-overview) <br/> |Корпоративная социальная сеть с расширенными безопасностью, администрированием и интеграцией.  <br/> |
   
> [!NOTE]
> Функции и политики, описанные в описании служб платформ [Microsoft 365 и Office 365,](../office-365-platform-service-description/office-365-platform-service-description.md) не применяются к службе Yammer. 
  
## <a name="yammer-enterprise-service-communications-policy"></a>Политика корпоративных коммуникаций yammer
<a name="YammerCommsPolicy"> </a>

Yammer придерживается политики управления изменениями [Microsoft 365,](https://aka.ms/ManageChange)но не использует целевой выпуск для выпуска обновлений. 
...
|:-----|:-----|
|**Изменения, требующие действий (план изменений)** <br/>Администратор, необходимый для внесения изменений для обеспечения работы службы, обновлений, которые могут повлиять на соответствие требованиям организации  <br/> |- Сообщения Центра сообщений Office 365 напрямую проверяются администраторами Yammer <br/>- Дорожная карта Microsoft 365<br/>- Обновления службы Yammer<br/>- Внешняя группа<br/>Если изменения затрагивают определенное множество пользователей, мы можем также напрямую их уведомить. |
|**Изменения, требующие осведомленности (оставайтесь в курсе)**<br/>Изменения, которые не требуют действий администратора, изменения визуального дизайна  <br/> |- Центр сообщений Office 365<br/>- Дорожная карта Microsoft 365<br/>- Обновления службы Yammer<br/>- Внешняя группа<br/>Если изменения затрагивают определенное множество пользователей, мы можем также напрямую их уведомить. |
...
|[Вход подключения Yammer](yammer-platform-features.md#yammer-connect-login) <br/> |Да  <br/> |Да  <br/> |
