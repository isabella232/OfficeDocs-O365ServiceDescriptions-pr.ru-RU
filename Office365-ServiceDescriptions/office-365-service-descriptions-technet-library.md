...
В этой библиотеке представлены подробные описания служб и функций, доступных в Microsoft 365 и Office 365. Чтобы сравнить функции в разных планах, см. ["Мощные](https://go.microsoft.com/fwlink/?LinkID=799177&amp;clcid=0x409) инструменты для поддержки предприятия или соответствующего описания службы" в списке ниже. 
  
Статьи и сведения о поддержке см. в справке office [& Training,](https://support.office.com/) [документации по Office](https://docs.microsoft.com/office/)для администраторов и ИТ-специалистов, а также в Центре справки Microsoft 365 для администраторов и [ИТ-специалистов.](https://docs.microsoft.com/microsoft-365/)
  
> [!NOTE]
> Если вы ищете таблицу сравнения описаний служб, она больше не будет. Таблицы доступности функций продуктов на каждой странице описания службы были обновлены, чтобы упростить выбор версии Office 365, которая соответствует вашим потребностям. 
  
Корпорация Майкрософт предлагает преимущество FastTrack Center для Office 365 для соответствующих требованиям служб в соответствующих планах. Это преимущество позволяет удаленно работать со специалистами Майкрософт, чтобы ваша среда Office 365 была готова к использованию. Дополнительные сведения см. в статье [Преимущество FastTrack Center для Office 365](https://docs.microsoft.com/fasttrack/O365-fasttrack-benefit-for-office-365).
  
Сначала следует ознакомиться с описанием следующих служб.
  
- [Описание служб платформы Microsoft 365 и Office 365](office-365-platform-service-description/office-365-platform-service-description.md)<sup>1</sup>
