...
Корпорация Майкрософт предлагает преимущества подписки на Office 365: для определенных служб в определенных планах. Эти преимущества позволяют удаленно работать со специалистами корпорации Майкрософт, чтобы подготавливать свою среду Office 365: к использованию. Дополнительные сведения см. в разделе [Office 365 Onboarding Benefit](http://technet.microsoft.com/library/cb4d7c0f-ad86-4134-a5fe-92a250cd3003.aspx).
