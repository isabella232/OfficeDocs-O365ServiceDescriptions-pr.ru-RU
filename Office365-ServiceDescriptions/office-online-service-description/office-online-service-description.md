...
Office веб-страницы (ранее Office веб-приложения) открывает документы Word, Excel, OneNote и PowerPoint в веб-браузере. Office веб-страницы упрощает работу и совместное использование Office из любой точки с подключением к Интернету практически с любого устройства. Microsoft 365 пользователи с word, Excel, OneNote или PowerPoint могут просматривать, создавать и изменять файлы в режиме go. 
  
## <a name="available-plans"></a>Доступные планы

Подробные сведения о планах подписки, которые позволяют пользователям Office веб-страницу, см. в полной таблице [сравнения подписки.](https://go.microsoft.com/fwlink/?linkid=2139145)
  
## <a name="feature-availability-across-office-for-the-web-plans"></a>Доступность функций Office для веб-планов

Нужна помощь в поиске решения Office подходит вашей организации? В следующих таблицах Office возможности веб-функций с богатыми Microsoft Office настольными приложениями. Используйте таблицы, чтобы узнать, какие функции доступны Office веб-сайте, а затем выберите имя функции, чтобы прочитать краткое описание того, как эта функция работает. Возможно, некоторые пользователи в организации нуждаются в расширенных возможностях диаграммы для настольного приложения Excel, в то время как другим требуется просматривать и слегка изменять документы Word и PowerPoint презентации с Office веб-Office. 
  
> [!NOTE]
>  Был выбран ограниченный выбор Office, которые будут представлять расширенные возможности Office настольного набора. Таблицы не являются исчерпывающим списком Microsoft Office функций. <br/>  Microsoft Приложения Microsoft 365 для предприятий является ежемесячным предложением подписки последнего пакета Office настольных компьютеров. <br/>  Microsoft Office Клиенты локального сервера Online Server получают Office лицензию на веб-редактирование, если они приобрели лицензию Office настольных пакетов (например, лицензию Office профессиональный плюс, Office стандартный или Приложения Microsoft 365 для предприятий). 
  
> [!NOTE]
> При открываемом Office документе в виде Outlook электронной почты или из библиотеки документов SharePoint, документ будет запущен в Office веб-страницы и будет только для чтения. Чтобы изменить документ в Office веб-сайте (режим редактирования), вам потребуется лицензия пакета, например Office 365 корпоративный E1. Чтобы изменить документ в настольном приложении, вам потребуется лицензия Office настольного пакета, например подписка Приложения Microsoft 365 для предприятий или установленная версия Office профессиональный плюс 2010 года. 
  
### <a name="word"></a>Word

| Возможности приложений | Word в Интернете | Приложение для настольных компьютеров Word |
|:-----|:-----|:-----|
...
|[Совместная работа, расширенный](word-online.md#collaboration-advanced) <br/> |Нет  <br/> |Да  <br/> |
|[элементы управления контентом;](word-online.md#content-controls) <br/> |Да  <br/> |Да  <br/> |
|[Титульные листы](word-online.md#cover-pages) <br/> |No<sup>1</sup> <br/> |Да  <br/> |
|[Создание дополнительных элементов документа](word-online.md#creation-of-advanced-document-elements) <br/> |Нет  <br/> |Да  <br/> |
|[Части и темы документа](word-online.md#document-parts-and-themes) <br/> |Нет  <br/> |Да  <br/> |
|[Dropbox](word-online.md#dropbox) <br/> |Да  <br/> |Да  <br/> |
|[Формулы](word-online.md#equations) <br/> |No<sup>1</sup> <br/> |Да  <br/> |
|[Поиск и замена](word-online.md#find-and-replace) <br/> |Да  <br/> |Да  <br/> |
|[Форматирование шрифта](word-online.md#font-formatting) <br/> |Да  <br/> |Да  <br/> |
|[Сноски и концевые сноски](word-online.md#footnotes-and-endnotes) <br/> |Да  <br/> |Да  <br/> |
|[Режим чтения с высокой четкостью](word-online.md#full-fidelity-reading-view) <br/> |Да  <br/> |Да  <br/> |
|[Наборы графических эффектов](word-online.md#graphic-effect-presets) <br/> |Да  <br/> |Да  <br/> |
|[Верхние и нижние колонтитулы](word-online.md#headers-and-footers) <br/> |Да  <br/> |Да  <br/> |
|[Гиперссылки](word-online.md#hyperlinks) <br/> |Да  <br/> |Да  <br/> |
|[Указатель](word-online.md#index) <br/> |No<sup>1</sup> <br/> |Да  <br/> |
|[Редактор ink] <br/> |Нет  <br/> |Да  <br/> |
|[Вставка изображений в Интернете](word-online.md#insert-online-pictures) <br/> |Да  <br/> |Да  <br/> |
|[Управление правами на доступ к данным и защита паролем](word-online.md#irm-and-password-protection) <br/> |Нет  <br/> |Да  <br/> |
...
|[Средства макета страниц, расширенные](word-online.md#page-layout-tools-advanced) <br/> |Нет  <br/> |Да  <br/> |
...
|[Печать, расширенный](word-online.md#printing-advanced) <br/> |Нет  <br/> |Да  <br/> |
|[Средства проверки правописания](word-online.md#proofing-tools) <br/> |Да  <br/> |Да  <br/> |
|[Средства проверки, расширенные](word-online.md#proofing-tools-advanced) <br/> |Нет  <br/> |Да  <br/> |
...
|[Помощник исследователя](word-online.md#researcher) <br/> |Нет  <br/> |Да  <br/> |
|[Мультимедиа](word-online.md#rich-media) <br/> |Нет  <br/> |Да  <br/> |
|[Форматирование таблиц](word-online.md#rich-table-formatting) <br/> |Да  <br/> |Да  <br/> |
|[Функции "Сохранить как" и "Загрузить копию"](word-online.md#save-as-and-download-a-copy) <br/> |Да  <br/> |Да  <br/> |
|[Сохранить как PDF](word-online.md#save-as-pdf) <br/> |Да  <br/> |Да  <br/> |
|[Предоставление общего доступа](word-online.md#share) <br/> |Да  <br/> |Да  <br/> |
|[Создание простой таблицы](word-online.md#simple-table-creation) <br/> |Да  <br/> |Да  <br/> |
|[SmartArt](powerpoint-online.md#smartart) <br/> |No<sup>1</sup> <br/> |Да  <br/> |
|[Главная таблица](word-online.md#table-of-authority) <br/> |No<sup>1</sup> <br/> |Да  <br/> |
|[Содержание](word-online.md#table-of-contents) <br/> |No<sup>1</sup> <br/> |Да  <br/> |
|[Нажмите кнопку](word-online.md#tap) <br/> |Нет  <br/> |Да  <br/> |
|[Подробнее](word-online.md#tell-me) <br/> |Да  <br/> |Да  <br/> |
|[Служба перевода](word-online.md#translation-service) <br/> |Да  <br/> |Да  <br/> |
|[Отмена и повтор](word-online.md#undo-and-redo) <br/> |Да  <br/> |Да  <br/> |
|[Скрипты VBA и форм](word-online.md#vba-and-forms-scripts) <br/> |Нет  <br/> |Да  <br/> |
|[Просмотр и добавление комментариев](word-online.md#view-and-add-comments) <br/> |Да  <br/> |Да  <br/> |
|[Подложки](word-online.md#watermarks) <br/> |No<sup>1</sup> <br/> |Да  <br/> |
|[Статистика](word-online.md#word-count) <br/> |Да  <br/> |Да  <br/> |
|[Масштабирование](word-online.md#zoom) <br/> |Да  <br/> |Да  <br/> |
   
> [!NOTE]
> <sup>1</sup> Эти отрисовки в зритель, но вы не можете создать или изменить их в Office для веб-сайта. <br/>
> <sup>2</sup> Некоторые, но не все, Office надстройки доступны. <br/>
  
### <a name="excel"></a>Excel

| Возможности приложений | Excel в Интернете | Excel настольного приложения |
|:-----|:-----|:-----|
|[Проверка читаемости](excel-online.md#add-hyperlinks) <br/> |Да  <br/> |Да  <br/> |
|[Добавление фонового цвета в вкладки листа](excel-online.md#add-background-color-to-sheet-tabs) <br/> |Да  <br/> |Да  <br/> |
...
|[Создание внешних подключений<sup>к данным 2</sup>](excel-online.md#create-external-data-connections) <br/> |No<sup>3</sup> <br/> |Да  <br/> |
...
|[Дубликат (копия) таблиц](excel-online.md#duplicate-copy-worksheets) <br/> |Да  <br/> |Да  <br/>|
|[Встраить книгу на веб-странице или в блоге (OneDrive)](excel-online.md#embed-workbook-on-web-or-blog-page-onedrive) <br/> |Да  <br/> |Нет  <br/> |
|[Внешние ссылки](excel-online.md#external-references-links) <br/> |No<sup>4</sup> <br/> |Да  <br/> |
|[Ручка заполнения](excel-online.md#fill-handle) <br/> |Да  <br/> |Да  <br/> |
...
|[Средства формулы, расширенные](excel-online.md#formula-tools-advanced) <br/> |Нет  <br/> |Да  <br/> |
...
|[Групповые данные](excel-online.md#group-data) <br/> |Да  <br/> |Да  <br/> |
...
|[Названные диапазоны](excel-online.md#named-ranges) <br/> |Да  <br/> |Да  <br/> |
...
|[Сводные таблицы](excel-online.md#pivottables) <br/> |Да  <br/> |Да  <br/> |
|[Публикация в социальной сети и настоящее сообщение в Интернете](excel-online.md#post-to-social-network-and-present-online) <br/> |Нет  <br/> |Да  <br/> |
...
|Refresh existing data connections <br/> |Нет  <br/> |Да  <br/> |
|[Удаление дублирующих значений](excel-online.md#remove-duplicate-values) <br/> |Да  <br/> |Да  <br/> |
...
|[Управление правами: безопасность IRM и паролей](excel-online.md#rights-management-irm-and-password-security) <br/> |Нет  <br/> |Да  <br/> |
|[Сохранение или скачивание копии](excel-online.md#save-or-download-a-copy) <br/> |Да  <br/> |Да  <br/> |
...
|[Общие данные](excel-online.md#total-data) <br/> |Да  <br/> |Да  <br/>|
...
> [!NOTE] 
> <sup>1</sup> Не удается создать PivotCharts, просмотр только.
 <br/><sup>2</sup> В зависимости от настройки среды поддерживаются некоторые виды подключений к данным для книг, отображаемых в Excel веб-страницы. Дополнительные сведения см. в книге "Обновление данных в окне браузера". 
 <br/><sup>3</sup> Вы не можете создавать или запускать макрос с помощью VBA Excel веб-страницы, но можно открывать и изменять электронные таблицы с поддержкой VBA, не удаляя (или развращая) VBA, содержащиеся в файле.
 <br/><sup>4</sup> В Excel веб-страницы последнее известное справочное значение отображается в окне браузера; однако он должен обновляться с помощью Excel настольного приложения. 
 <br/><sup>5</sup> Некоторые, но не все Office надстройки доступны. 
  
### <a name="onenote"></a>OneNote

| Возможности приложений | OneNote в Интернете | OneNote настольного приложения |
|:-----|:-----|:-----|
...
|[Буфер обмена](onenote-online.md#clipboard) <br/> |Да  <br/> |Да  <br/> |
|[Вырезка](onenote-online.md#clipping-experiences) <br/> |Нет  <br/> |Да  <br/> |
...
|Перетаскивания и сброса страниц <br/> |Да  <br/> |Да <br/> |
|Перетаскивания и сброса разделов <br/> |Да  <br/> |Да <br/> |
|Группы разделов перетаскивания и сброса <br/> |Нет  <br/> |Да <br/> |
...
|[Управление записной книжкой: перекрестная подача страниц разделов и записных записей, переуправление разделов, создание и удаление групп разделов](onenote-online.md#notebook-management-cross-sectionnotebook-page-filing-section-re-order-createdelete-section-groups) <br/> |Да<sup>1</sup> <br/> |Да  <br/> |
...
|[Печать](onenote-online.md#print) <br/> |Да  <br/> |Да  <br/> |
|[Средства проверки правописания](onenote-online.md#proofing-tools) <br/> |Да  <br/> |Да  <br/> |
|Rights Management: IRM and password security <br/> |Нет  <br/> |Да  <br/> |
|[Поиск по: тегу, названию, автору и дате, звуковым заметкам](onenote-online.md#search-by-tag-title-authordate-audio-notes) <br/> |Да<sup>3</sup> <br/> |Да  <br/> |
|[Поиск (на странице, в рамках разделов)](onenote-online.md#search-on-page-within-sections) <br/> |Да  <br/> |Да  <br/> |
|[Предоставление общего доступа](onenote-online.md#share) <br/> |Да  <br/> |Да  <br/> |
...
> [!NOTE]
> <sup>1</sup> В OneNote веб-страницы можно переместить разделы в записную книжку и скопировать и вклеить страницы из одного раздела в другой. 
 <br/> <sup>2</sup> Некоторые, но не все, Office надстройки доступны. 
 <br/><sup>3</sup> Вы можете искать на странице или разделе, но не на всех ноутбуках или в ноутбуках (как это возможно в настольной версии).
 <br/><sup>4</sup> В настольной версии не существует параметра "скачивание", но можно сохранить как в другом расположении. 
  
### <a name="powerpoint"></a>PowerPoint

| Возможности приложений | PowerPoint в Интернете | PowerPoint настольного приложения |
|:-----|:-----|:-----|
...
|[Навигация — сортиер слайдов](powerpoint-online.md#navigation---slide-sorter) <br/> |Да  <br/> |Да  <br/> |
...
|[Изображения](powerpoint-online.md#pictures) <br/> |Да  <br/> |Да  <br/> |
|[Режим докладчика](powerpoint-online.md#presenter-view) <br/> |Нет  <br/> |Да  <br/> |
|[Показ презентаций через Интернет с помощью Skype для бизнеса или службы презентаций Office](powerpoint-online.md#present-online-through-skype-for-business-or-the-office-presentation-service) <br/> |Да  <br/> |Да  <br/> |
...
|[Инструменты рецензента, расширенные](powerpoint-online.md#reviewer-tools-advanced) <br/> |Нет  <br/> |Да  <br/> |
|Управление правами: безопасность IRM и паролей <br/> |Нет  <br/> |Да  <br/> |
|[Запуск слайд-шоу](powerpoint-online.md#run-slide-show) <br/> |Да  <br/> |Да  <br/> |
|[Сохранение или скачивание копии](powerpoint-online.md#save-as-or-download-a-copy) <br/> |Да  <br/> |Да  <br/> |
...
> [!NOTE]
><sup>1</sup> PowerPoint веб-страницы поддерживает галерею из восьми переходов и 37 анимаций. Для большего выбора или создания настраиваемой анимации используйте PowerPoint настольное приложение. 
 <br/>
<sup>2</sup> Устройство, над которое вы работаете, должно поддерживать ink. <br/> 
<sup>3</sup> Некоторые, но не все, Office надстройки доступны. <br/>
<sup>4</sup> Вы не можете создавать pivotCharts или PivotTables, но вы можете видеть их в зритель. 
  
## <a name="supported-file-types-for-office-for-the-web"></a>Поддерживаемые типы Office для веб-сайтов
...
|Другие (DOTM, DOTX)  <br/> |Да  <br/> |Нет  <br/> |
|OpenDocument (ODT)  <br/> |Да  <br/> |Да  <br/> |
|Portable Document Format (PDF)  <br/> |Нет  <br/> |Нет  <br/> |
|**Книги Excel, созданные в Excel 97 или более поздней версии** <br/> |**Режим просмотра** <br/> |**Режим редактирования** <br/> |
...
|**Презентации PowerPoint, созданные в программе PowerPoint 97 или более поздней версии** <br/> |**Режим просмотра** <br/> |**Режим редактирования** <br/> |
|Open XML (PPTX, PPSX)  <br/> |Да  <br/> |Да  <br/> |
|Двоичный файл (PPT, PPS)  <br/> |Да  <br/> |Файлы, преобразованные в PPTX или PPSX  <br/> |
|Шаблон (POT, POTX)  <br/> |Да  <br/> |Нет  <br/> |
|Макросы (PPTM, POTM, PPAM, POTX, PPSM)  <br/> |Да<sup>1</sup> <br/> |Нет  <br/> |
|Надстройки (PPA, PPAM)  <br/> |Нет  <br/> |Нет  <br/> |
|OpenDocument (ODP)  <br/> |Да  <br/> |Да  <br/> |
   
> [!NOTE]
> <sup>1</sup> Макросы нельзя запускать или изменять.<br/>
> <sup>2</sup> Если макрос существует, пользователям будет предложено сохранить копию файла с удалеными макросами.<br/> 
