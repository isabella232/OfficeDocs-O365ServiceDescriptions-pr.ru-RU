...
Office для Интернета (ранее Office веб-приложения) открывает документы Word, Excel, OneNote и PowerPoint в веб-браузере. Office для Интернета упрощает работу и совместное использование Office из любой точки с подключением к Интернету практически с любого устройства. Microsoft 365 пользователи с word, Excel, OneNote или PowerPoint могут просматривать, создавать и изменять файлы в режиме go. 
...
## <a name="feature-availability-across-office-for-the-web-plans"></a>Доступность функций в Office для Интернета планах

Нужна помощь в поиске решения Office подходит вашей организации? В следующих таблицах Office для Интернета возможности функций с богатыми Microsoft Office настольными приложениями. Используйте таблицы, чтобы узнать, какие функции доступны в Office для Интернета, а затем выберите имя функции, чтобы прочитать краткое описание того, как эта функция работает. Возможно, некоторые люди в организации нуждаются в расширенных возможностях диаграммы для настольного приложения Excel, в то время как другим требуется просматривать и слегка изменять документы Word и PowerPoint презентации с Office для Интернета. 
  
> [!NOTE]
>  Был выбран ограниченный выбор Office, которые будут представлять расширенные возможности Office настольного набора. Таблицы не являются исчерпывающим списком Microsoft Office функций. <br/>  Microsoft Приложения Microsoft 365 для предприятий является ежемесячным предложением подписки последнего пакета Office настольных компьютеров. <br/>  Microsoft Office Клиенты на локальном сервере online Server получают лицензию Office для Интернета редактирования, если приобрели лицензию на настольный набор Office (например, лицензию Office профессиональный плюс, Office стандартный или Приложения Microsoft 365 для предприятий). 
  
> [!NOTE]
> Когда вы откроете Office, Outlook электронной почты или из библиотеки документов SharePoint, документ будет запущен в Office для Интернета и будет только для чтения. Чтобы изменить документ в Office для Интернета (режим редактирования), вам потребуется лицензия пакета, например Office 365 корпоративный E1. Чтобы изменить документ в настольном приложении, вам потребуется лицензия Office настольного пакета, например подписка Приложения Microsoft 365 для предприятий или установленная версия Office профессиональный плюс 2010 года. 
...
> [!NOTE]
> <sup>1</sup> Эти отрисовки в зритель, но вы не можете создать или изменить их в Office для Интернета. <br/>
...
> <sup>1</sup> Не удается создать PivotCharts, просмотр только.
 <br/><sup>2</sup> В зависимости от настройки среды для книг, отображаемых в Excel для Интернета, поддерживаются некоторые виды подключений к данным. Дополнительные сведения см. в книге "Обновление данных в окне браузера". 
 <br/><sup>3</sup> Вы не можете создавать или запускать макрос с помощью VBA в Excel для Интернета, но можно открывать и изменять электронные таблицы с поддержкой VBA, не удаляя (или развращая) VBA, содержащиеся в файле.
 <br/><sup>4</sup> В Excel для Интернета отображается последнее известное справочное значение в окне браузера; однако он должен обновляться с помощью Excel настольного приложения. 
...
> [!NOTE]
> <sup>1</sup> В OneNote для Интернета можно переместить разделы в блокнот, а также скопировать и вклеить страницы из одного раздела в другой. 
...
> [!NOTE]
><sup>1</sup> PowerPoint для Интернета поддерживает галерею из восьми переходов и 37 анимаций. Для большего выбора или создания настраиваемой анимации используйте PowerPoint настольное приложение. 
 <br/>
...
## <a name="supported-file-types-for-office-for-the-web"></a>Поддерживаемые типы файлов для Office для Интернета
