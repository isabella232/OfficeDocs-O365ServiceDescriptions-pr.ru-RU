...
Office for the web (ранее Office Web Apps) открывает документы Word, Excel, OneNote и PowerPoint в вашем веб-браузере. Office для Интернета упрощает работу и совместное использование файлов Office из любого места с подключением к Интернету практически с любого устройства. Клиенты Microsoft 365 с помощью Word, Excel, OneNote или PowerPoint могут просматривать, создавать и изменять файлы в режиме go. 
  
## <a name="available-plans"></a>Доступные планы

Подробные сведения о планах подписки, которые позволяют пользователям Для Office для Интернета, см. в полной [таблице сравнения подписки.](https://go.microsoft.com/fwlink/?linkid=2139145)
  
## <a name="feature-availability-across-office-for-the-web-plans"></a>Доступность функций в Office для веб-планов

Нужна помощь в поиске решения Office, которое лучше всего подходит вашей организации? В следующих таблицах сравнивают возможности Office для веб-функций с богатыми Microsoft Office настольными приложениями. Используйте таблицы, чтобы узнать, какие функции доступны в Office для Интернета, а затем выберите имя функции, чтобы прочитать краткое описание того, как эта функция работает. Возможно, вы обнаружите, что некоторым людям в вашей организации требуется расширенный потенциал диаграммы для настольного приложения Excel, а другим требуется только просматривать и слегка изменять документы Word и презентации PowerPoint в Office для веб-сайта. 
  
> [!NOTE]
>  Для представления расширенных возможностей настольного пакета Office был выбран ограниченный выбор функций Office. Таблицы не являются исчерпывающим списком Microsoft Office функций. <br/>  Microsoft Microsoft 365 Apps для предприятия — это ежемесячное предложение по подписке последнего настольного пакета Office. <br/>  Microsoft Office клиенты на локальном сервере получают лицензию Office для веб-редактирования, если приобрели лицензию на настольный набор Office (например, лицензию на настольные компьютеры Office Office профессиональный плюс, Office Standard или Microsoft 365 Apps для корпоративной лицензии). 
  
> [!NOTE]
> Когда вы откроете документ Office в виде вложения электронной почты Outlook или из библиотеки документов SharePoint, документ будет запущен в Office для веб-сайта и будет только для чтения. Для редактирования документа в Office для веб-сайта (режим редактирования) требуется лицензия пакета, например Office 365 Enterprise E1. Чтобы изменить документ в настольном приложении, вам потребуется лицензия на настольный набор Office, например Microsoft 365 Apps для корпоративной подписки или установленная версия Office профессиональный плюс 2010 года. 
...
> [!NOTE]
> <sup>1</sup> Эти отрисовки в зрительном ок, но вы не можете создать или изменить их в Office для веб-сайта. <br/>
> <sup>2</sup> Некоторые, но не все надстройки Office доступны. <br/>
  
### <a name="excel"></a>Excel

| Возможности приложений | Excel в Интернете | Настольное приложение Excel |
|:-----|:-----|:-----|
...
> <sup>1</sup> Не удается создать PivotCharts, просмотр только.
 <br/><sup>2</sup> В зависимости от настройки среды поддерживаются некоторые виды подключений к данным для книг, отображаемых в Excel для интернета. Дополнительные сведения см. в книге "Обновление данных в окне браузера". 
 ...
 <br/><sup>4</sup> В Excel для веб-сайта отображается последнее известное справочное значение в окне браузера; Однако он должен обновляться с помощью настольного приложения Excel. 
 <br/><sup>5</sup> Некоторые, но не все надстройки Office доступны. 
  
### <a name="onenote"></a>OneNote

| Возможности приложений | OneNote в Интернете | Настольное приложение OneNote |
|:-----|:-----|:-----|
...
> [!NOTE]
> <sup>1</sup> В OneNote для Интернета можно переместить разделы в блокнот и скопировать и вклеить страницы из одного раздела в другой. 
 <br/> <sup>2</sup> Некоторые, но не все надстройки Office доступны. 
...
| Возможности приложений | PowerPoint в Интернете | Настольное приложение PowerPoint |
|:-----|:-----|:-----|
...
> [!NOTE]
><sup>1</sup> PowerPoint для веб-страницы поддерживает галерею из восьми переходов и 37 анимаций. Для большего выбора или создания настраиваемой анимации используйте настольное приложение PowerPoint. 
 <br/>
<sup>2</sup> Устройство, над которое вы работаете, должно поддерживать ink. <br/> 
<sup>3</sup> Некоторые, но не все надстройки Office доступны. <br/>
<sup>4</sup> Вы не можете создавать pivotCharts или PivotTables, но вы можете видеть их в зритель. 
  
## <a name="supported-file-types-for-office-for-the-web"></a>Поддерживаемые типы файлов для Office для веб-сайта
