...
description: SharePoint Online — это семейство веб-средств и технологий, которые помогут вашей организации хранения, совместного использования и управления цифровыми. Созданные на Microsoft SharePoint Server 2013 в этом размещенной службы идеально подходит для работы над проектами, хранения данных и документы в одном месте и обмен информацией с другими пользователями. Следующие возможности содержимого упрощает Enterprise Content Management (ECM) для всех пользователей. Это сочетание традиционных управление содержимым, возможностей социальных вычислений и мощное средство поиска.
ms.openlocfilehash: 4d091a912d90028be32269cc91692155b146e671
ms.sourcegitcommit: d6dfbaacd56c0855e12500b38acd06be16cd1560
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/19/2018
ms.locfileid: "24036820"
---
...
Администраторы семейства веб-сайтов SharePoint Online могут использовать функцию аудита для отслеживания действий пользователей на сайтах, типов контента, списков, библиотек, элементов списков и файлов библиотек в семействах веб-сайтов. Дополнительные сведения см. в статье [Настройка параметров аудита для семейства веб-сайтов](https://go.microsoft.com/fwlink/?LinkId=270950).
  
## <a name="auditing-amp-reporting-eg-doc-edits-policy-edits-deletes"></a>Аудит &amp; отчетов (например, редактирование документов, изменение политик, удаления)
...
## <a name="category-page-and-catalog-item-page"></a>Страницы категорий и страницы позиций каталога
...
## <a name="document-translation-in-word-online"></a>Перевод документов в Word Online
...
## <a name="external-sharing-guest-link"></a>Внешний общий доступ: гостевые ссылки
...
SharePoint Online IRM с помощью Azure Information Protection технология защиты информации в Office 365. Защиту IRM применяется к файлам на уровнях списков и библиотек SharePoint. Дополнительные сведения о [IRM в SharePoint Online](https://go.microsoft.com/fwlink/?LinkId=270963).
...
## <a name="multi-stage-disposition"></a>Многоступенчатое расположение
...
## <a name="office-online-createedit"></a>Office Online (создание и изменение)
...
Администраторы SharePoint Online могут восстановить удаленные семейства сайтов с помощью Центра администрирования SharePoint. Дополнительные сведения см. в статье [Восстановление удаленного семейства веб-сайтов](https://go.microsoft.com/fwlink/p/?LinkId=286114). 
...
## <a name="search-web-parts"></a>Веб-частей поиска
...
## <a name="unique-document-ids"></a>Уникальные идентификаторы документов
...
## <a name="wcm-search-engine-optimizations-seo"></a>WCM: оптимизация поисковых систем (SEO)
<a name="bkmk_WCMSearchEngineOptimizations"> </a>

Для связи с новыми и старыми клиентами очень важна оптимизация поиска на общедоступном веб-сайте. Служба SharePoint Online включает встроенные возможности SEO. Например, организации могут легко улучшить результаты поиска на сайтах, используя настраиваемый файл robots.txt и метатеги на уровне страниц. Дополнительные сведения см. в разделе [Оптимизация веб-сайта для поиска](https://go.microsoft.com/fwlink/?LinkId=270932).
