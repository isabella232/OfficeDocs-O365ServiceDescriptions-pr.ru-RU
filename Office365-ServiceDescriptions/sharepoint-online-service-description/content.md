...
Служба управления правами на доступ к данным SharePoint Online использует Azure Information Protection, технологию защиты информации в Office 365. Защита IRM применяется к файлам на уровнях списков и библиотек SharePoint. Дополнительные сведения о [IRM в SharePoint Online](https://go.microsoft.com/fwlink/?LinkId=270963).
