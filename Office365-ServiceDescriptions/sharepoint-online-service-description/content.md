...
SharePoint Online Администраторы семейства сайтов можно использовать функцию аудита для отслеживания пользователей, которые измерений действия, которые в сайты, типов контента, списков, библиотек, элементы списков и файлов библиотеки семейств веб-сайтов. Дополнительные сведения о [настройке параметров аудита для семейства веб-сайтов](https://go.microsoft.com/fwlink/?LinkId=270950).
...
Оптимизация общедоступного веб-сайта для поиска очень важна для соединения с клиентами новые и возвращает ошибку. SharePoint Online включает в себя встроенные функции SEO, например, настраиваемый файл robots.txt и metatagging уровня страницы, поэтому организаций легко настроить сайтов для улучшения результатов поиска.
