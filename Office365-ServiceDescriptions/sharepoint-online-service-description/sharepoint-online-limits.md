...
| Компонент | Microsoft 365 бизнес базовый, Бизнес Standard или бизнес премиум | Microsoft 365 E3 или 1/д, Office 365 E1, E3 или 1/2 или SharePoint (план 1) | Microsoft 365 F1 или F3, Office 365 F3 |
|:-----|:-----|:-----|:-----|
...
Допустимый лимит составляет 50 000 с уникальными разрешениями, но рекомендуемый общий лимит — 5 000. Одновременное внесение изменений в более чем 5 000 элементов с уникальными разрешениями занимает больше времени. Для больших списков структура может иметь как можно меньше уникальных разрешений.
...
**Текущее приложение синхронизации OneDrive (OneDrive.exe)** — для достижения оптимальной производительности рекомендуется хранить не более 300 000 файлов на каждого пользователя во всех синхронизированных библиотеках документов, даже если вы используете файлы по требованию или выбрали только некоторые папки в библиотеках для синхронизации.

**Предыдущее приложение синхронизации OneDrive для бизнеса (Groove.exe — используется с более старыми локальными средами SharePoint)** — вы можете синхронизировать до 20 000 элементов во всех синхронизированных библиотеках. Сюда входят библиотеки OneDrive, библиотеки сайтов группы или и то, и другое. В отдельном от общего числа синхронизаций количество элементов, которые можно синхронизировать для каждого типа библиотеки, ограничено.
