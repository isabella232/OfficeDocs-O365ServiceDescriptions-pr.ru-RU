...
- **Темы Viva**  предоставляет опыт обнаружения знаний, который помогает людям подключаться к информации и экспертам по всей компании. Используя AI для анализа данных Microsoft 365 клиента, Viva Topics автоматически всплыла в беседах и документах в Microsoft 365 и Teams. Щелкнув карточку, откроет страницу темы с связанными документами, беседами, видео и людьми. В настоящее время Viva Topics обычно доступна в качестве надстройки для Microsoft 365 коммерческих планов.
...
| Viva Topics — Graph <sup>содержимого соединители2, 4</sup> — емкость для 500 индексных3 удаленных<sup></sup> элементов на каждого используемое, с пулом  | Нет  | Нет  | Нет  | Нет  | Да<sup>2</sup>  | Нет  |
| Viva Аналитика <sup>5</sup> — личные сведения (MyAnalytics) бесплатно с поддерживаемых планов   | Нет  | Нет  | Да  | Да | Да | Да |
| Viva Аналитика <sup>6</sup> — сведения о роли для руководителей, руководителей и аналитиков (в Teams и в Workplace Analytics) за дополнительную плату с поддерживаемых планов   | Да  | Нет  | Да | Да | Да | Да |
...
| Viva Обучение <sup>7</sup> — организация создает обучающий контент, на который SharePoint | Да | Да | Да | Да | Да | Да |
| Viva Обучение <sup>7</sup> — 125 Обучение и полные библиотеки Microsoft Learn и Microsoft 365 Training | Да | Да | Да | Да | Да | Да |
| Viva Обучение <sup>7</sup> — интеграция с Обучение системами управления и поставщиками контента для обучения | <sup>Yes8</sup> | <sup>Yes8</sup> | <sup>Yes8</sup> | <sup>Yes8</sup> | <sup>Yes8</sup> | <sup>Yes8</sup> |
...
Подробные сведения Microsoft 365 и Office 365 плана см. в таблице сравнения  [подписки.](https://www.microsoft.com/microsoft-365/compare-microsoft-365-enterprise-plans)
