...
С Outlook 2010 или более поздней и Outlook веб-страницы пользователи могут применять политики хранения к папкам, беседам или отдельным сообщениям. Они также могут просматривать примененные политики хранения и даты ожидаемого удаления сообщений. Пользователи других почтовых клиентов могут только удалять или архивировать сообщения на основе серверных политик хранения, установленных администратором.
...
- Добавьте политики Советы, которые помогут снизить потерю данных, отобразив уведомление в Outlook 2016, Outlook 2013, Outlook в Интернете и OWA для пользователей устройств, а также могут повысить эффективность политик, разрешив ложные сообщения. 
