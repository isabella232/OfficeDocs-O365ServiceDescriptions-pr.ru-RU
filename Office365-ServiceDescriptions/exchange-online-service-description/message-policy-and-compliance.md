...
description: Узнайте о политике и соблюдении правил сообщения в Exchange Online.
...
- **Outlook 2016, Outlook 2013 г., Outlook 2010** г. и Outlook в Интернете Пользователи имеют доступ к полным функциям архива, а также связанным функциям соответствия требованиям, таким как контроль над политиками хранения и архива. 
...
Только данные обмена сообщениями одного пользователя могут храниться в каждом личном архиве. Распределение хранилища зависит от плана подписки. Дополнительные сведения о размерах архивных почтовых ящиков см. в разделе "Ограничения хранения почтовых [ящиков" в Exchange Online пределах.](exchange-online-limits.md)
  
> [!IMPORTANT]
> - Не разрешается использование функции ведения журнала, правил транспорта или правил автоматической пересылки для копирования сообщений на почтовый ящик Exchange Online, чтобы создать архив. Корпорация Майкрософт оставляет за собой право отказать в дополнительном хранилище архивов в тех случаях, когда архив почтовых ящиков не используется в личном сценарии или в других случаях ненадлежащего использования.
...
> - Exchange Online не поддерживает комлет _New-MailboxImportRequest_ Windows PowerShell 2010 Exchange Server 2010 Пакет обновления или более поздней части для импорта файлов pst в личный архив, управляемый администратором. Если у пользователя имеется и основной почтовый ящик, и архив в Exchange Online, администратор может использовать бесплатный инструмент PST Capture для импорта данных PST-файлов в основной или архивный почтовый ящик пользователя.
...
С Outlook 2010 или Outlook в Интернете 2010 г. пользователи могут применять политики хранения к папкам, беседам или отдельным сообщениям. Они также могут просматривать примененные политики хранения и даты ожидаемого удаления сообщений. Пользователи других почтовых клиентов могут только удалять или архивировать сообщения на основе серверных политик хранения, установленных администратором.
...
Шифрование данных клиентов в режиме покоя обеспечивается несколькими технологиями, в том числе BitLocker, DKM, служба хранилища Azure Service Encryption и шифрованием служб в Exchange Online, Skype для бизнеса, OneDrive для бизнеса и SharePoint Online. Office 365 Шифрование служб включает возможность использования управляемых клиентами ключей шифрования, хранимых в Хранилище ключей Azure. Этот параметр ключа с управлением клиентом, называемый ключом [клиента,](/microsoft-365/compliance/customer-key-overview)доступен для Exchange Online, SharePoint Online и OneDrive для бизнеса. 
...
шифрование сообщений Office 365 позволяет пользователям электронной почты отправлять зашифрованные сообщения электронной почты любому пользователю. Мы объявили о новых возможностях в Office шифрования сообщений, которые используют функции защиты в шифровании информации Azure. Эти новые возможности предоставляют расширенные возможности для конечных пользователей, которые упрощают совместное взаимодействие и совместное взаимодействие с защищенными сообщениями с любыми пользователями в организации или за ее пределами. Новые возможности Office шифрования сообщений имеют некоторые требования к настройке. См. в шифрование сообщений Office 365 новые возможности, построенные на основе Azure Information Protection. Клиенты, шифрование сообщений Office 365 не получают новые возможности, не следуя вышеуказанной инструкции по настройкам. Дополнительные [сведения](https://support.office.com/article/Office-365-Message-Encryption-FAQ-0432dce9-d9b6-4e73-8a13-4a932eb0081e) о том, что включено в новые возможности по сравнению с шифрование сообщений Office 365, ознакомьтесь с шифрование сообщений Office 365. 

Расширенное шифрование сообщений Office 365 обеспечивает дополнительную защиту, разрешая истечение и отзыв сообщений.  Вы также можете создать несколько шаблонов для зашифрованных сообщений электронной почты, исходя из вашей организации.  Расширенный шифрование сообщений включен в Microsoft 365 E5, Office 365 E5, Microsoft 365 E5 (некоммерческие цены персонала), Office 365 корпоративный E5 (некоммерческие цены персонала) или Office 365 для образования A5. Если ваша организация имеет подписку, которая не включает Расширенное шифрование сообщений Office 365, вы можете приобрести Соответствие требованиям Microsoft 365 E5 или Office 365 Advanced Compliance SKU в качестве надстройки.
...
S/MIME поддерживается на Microsoft Edge и Internet Explorer 11. В настоящее время браузеры Firefox, Opera и Chrome не поддерживают протокол S/MIME. Дополнительные сведения см. [в s/MIME для подписи сообщений и шифрования.](/Exchange/policy-and-compliance/smime?preserve-view=true&view=exchserver-2019)
...
- Обнаружение конфиденциальной информации в вложениях сообщений, тексте тела или строках субъекта и настройка уровня доверия, на котором Exchange Online действий.
...
- Добавьте политики Советы, которые помогут снизить потерю данных, отобразив уведомление пользователям Outlook 2016, Outlook 2013, Outlook в Интернете и OWA для устройств, а также повысить эффективность политик, разрешив ложные сообщения. 
...
- Убедитесь, что назначение журнала не является Exchange Online почтовым ящиком.
