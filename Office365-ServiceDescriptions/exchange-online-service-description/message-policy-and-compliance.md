...
description: Сведения о политике сообщений и совместимости в Exchange Online.
ms.openlocfilehash: d723d686e3e939753e8007d41b0fdaf0d0363524
ms.sourcegitcommit: e342174df76128430dfc8c971716da5c4b2942ac
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/28/2020
ms.locfileid: "48293835"
---
...
Дополнительные сведения о правилах потока обработки почты см. в статье [Mail flow rules in Exchange 2016](https://docs.microsoft.com/Exchange/policy-and-compliance/mail-flow-rules/mail-flow-rules?view=exchserver-2019&preserve-view=true).
