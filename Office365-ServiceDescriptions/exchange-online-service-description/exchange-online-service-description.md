...
|**[Политика обмена сообщениями и соответствие требованиям](message-policy-and-compliance.md)**|**Exchange Server 2013**|**Exchange Server 2016**|**Office 365 бизнес базовый**|**Office 365 бизнес премиум**|**Office 365 корпоративный E1**|**Office 365 корпоративный E3**|**Office 365 корпоративный E5**|**Office 365 корпоративный F1**|
|Архивирование почтовых ящиков на основе сервера Exchange Online| Нет|Нет|Да|Да|Да|Да|Да|Нет|
...
|Правила транспорта|Да <sup>4</sup>|Да<sup>4</sup>|Да<sup>4</sup>|Да<sup>4</sup>|Да<sup>4</sup>|Да<sup>4</sup>|Да<sup>4</sup>|Да<sup>4</sup>|
...
|Настройка политик защиты от нежелательной почты|Да, но только через PowerShell|Да, но только через PowerShell|Да|Да|Да|Да|Да|Да <sup>7</sup>|
...
|Настройка политик защиты от вредоносных программ|Да|Да|Да|Да|Да|Да|Да|Да <sup>7</sup>|
...
|**[Поток почты](mail-flow.md)**|**Exchange Server 2013**|**Exchange Server 2016**|**Office 365 бизнес базовый**|**Office 365 бизнес премиум**|**Office 365 корпоративный E1**|**Office 365 корпоративный E3**|**Office 365 корпоративный E5**|**Office 365 корпоративный F1**|
...
|Условная маршрутизация почты|Нет|Нет|Да|Да|Да|Да|Да|Да|
|Добавление партнера в список безопасных входящих сообщений|Нет|Нет|Да|Да|Да|Да|Да|Да|
|Маршрутизация гибридной почты|Да|Да|Да,<sup>16</sup>|Да,<sup>16</sup>|Да|Да|Да|Да|
...
|Рабочая книга отчетов Excel|Нет|Нет|Да|Да|Да|Да|Да|Да|
|Отчеты веб-служб|Нет|Нет|Да|Да|Да|Да|Да|Да|
|Трассировка сообщений|Нет|Да|Да|Да|Да|Да|Да|Да|
...
|Федеративное совместное использование (в том числе, публикация календаря)|Да|Да|Да|Да|Да|Да|Да|Да|
...
|**[Высокая доступность и непрерывность бизнес-процессов](high-availability-and-business-continuity.md)**|**Exchange Server 2013**|**Exchange Server 2016**|**Office 365 бизнес базовый**|**Office 365 бизнес премиум**|**Office 365 корпоративный E1**|**Office 365 корпоративный E3**|**Office 365 корпоративный E5**|**Office 365 корпоративный F1**|
...
|Сведения о присутствии из Skype для бизнеса в Outlook Web App и Outlook|Да|Да|Да|Да|Да|Да|Да|Да|
|Взаимодействие с SharePoint|Да|Да|Да|Да|Да|Да|Да|Да|
|Поддержка связи с EWS|Да|Да|Да|Да|Да|Да|Да|Нет|
...
|Политики назначения роли|Да|Да|Да|Да|Нет|
...
|Архивирование почтовых ящиков на основе сервера Exchange Online|Да|Нет|Да|Да|Нет|
...
|Настройка политик защиты от нежелательной почты|Да, но только через PowerShell|Да, но только через PowerShell|Да|Да|Да <sup>8</sup>|
|Встроенная защита от вредоносных программ|Да <sup>7</sup>|Да <sup>7</sup>|Да<sup>7</sup>|Да<sup>7</sup>|Да<sup>7</sup>|
|Настройка политик защиты от вредоносных программ|Да|Да|Да|Да|Да <sup>8</sup>|
...
|Пользовательская маршрутизация исходящей почты|Да|Да|Да|Да|Да|
|Безопасный обмен сообщениями с доверенным партнером|Да|Да|Да|Да|Да|
|Условная маршрутизация почты|Нет|Нет|Да|Да|Да|
|Добавление партнера в список безопасных входящих сообщений|Нет|Нет|Да|Да|Да|
|Маршрутизация гибридной почты|Да|Да|Да|Да|Да|
...
|Оповещения о емкости|Да|Да|Да|Да|Да|
...
|Внешние контакты (глобальные)|Да|Да|Да|Да|Да|
...
|Сведения об отсутствии на работе|Да|Да|Да|Да|Да|
|Предоставление общего доступа к календарю|Да|Да|Да|Да|Да <sup>18</sup>|
...
|Рабочая книга отчетов Excel|Нет|Нет|Да|Да|Да|
|Отчеты веб-служб|Нет|Нет|Да|Да|Да|
|Трассировка сообщений|Нет|Да|Да|Да|Да <sup>8</sup>|
...
|Outlook Web App|Да|Да|Да|Да|Да|
...
|Взаимодействие со сторонней голосовой почтой|Да|Да|Да|Да|Да|
...
|Сведения о присутствии из Skype для бизнеса в Outlook Web App и Outlook|Да|Да|Да|Да|Да|
|Взаимодействие с SharePoint|Да|Да|Да|Да|Да|
|Поддержка связи с EWS|Да|Да|Да|Да|Да|
