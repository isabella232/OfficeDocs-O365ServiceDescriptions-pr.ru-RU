...
> [!NOTE]
> Если вам нужна помощь в задаче или при устранении неполадок, возможно, вы найдете следующие материалы: <br/>
...
[Помощник по поддержке и восстановлению Майкрософт](https://diagnostics.office.com/)<br/> 
...
Чтобы сравнить функции в планах, ознакомьтесь со статьей [мощные средства для поддержки предприятия](https://products.office.com/business/compare-more-office-365-for-business-plans). Чтобы сравнить планы для Office 365 Германия, ознакомьтесь с [планами подписки на office 365 Германия](https://go.microsoft.com/fwlink/?linkid=839016).
...
Сведения о новых возможностях в центре администрирования Exchange можно найти в статьях [новые возможности в центре администрирования Exchange](https://docs.microsoft.com/exchange/whats-new).
...
Требования к системе для корпоративных, образовательных и правительственных организаций, доступных на основе подписок на основе подписок, можно найти в [статье Microsoft 365 и ресурсы Office](https://products.office.com/office-system-requirements/#Office365forBEG).
...
|Защитник Майкрософт для Office 365|Нет|Да|Нет|Нет|Нет|Нет|Да|Нет|
...
|**Расширение настройки службы, надстроек и ресурсов**|**Exchange Server 2013**|**Exchange Server 2016**|**Microsoft 365 бизнес базовый**|**Microsoft 365 бизнес стандарт**|**Office 365 корпоративный E1**|**Office 365 корпоративный E3**|**Office 365 корпоративный E5**|**Office 365 корпоративный F3**|
...
<sup>5</sup> для Exchange 2013 для защиты от потери данных требуется клиентская лицензия Exchange Enterprise (CAL). Дополнительные сведения о клиентских лицензиях и лицензировании серверов можно найти в статье [вопросы и ответы по лицензированию Exchange](https://products.office.com/exchange/microsoft-exchange-licensing-faq-email-for-business). <br/>
...
<sup>9</sup> подписку на EOA можно приобрести отдельно для каждого почтового ящика, который требует неактивного почтового ящика или архивной функции.<br/>
...
<sup>23</sup> служба единой системы обмена сообщениями Exchange Online для сторонних систем УАТС с прямыми подключениями от пользователя, который управляется с помощью SBCs, будет завершаться 2019 апреля. Дополнительную информацию можно узнать в статье Exchange Online Blog [support для пограничных контроллеров сеансов в единой системе обмена сообщениями Exchange Online](https://techcommunity.microsoft.com/t5/Exchange-Team-Blog/New-date-for-discontinuation-of-support-for-Session-Border/ba-p/607853). <br/>
<sup>24</sup> пользователь F3 не может добавлять представителей в свой почтовый ящик, но может получить доступ к другому почтовому ящику (включая общие почтовые ящики) и выполнить все действия, делегированные им.<br/>
...
<sup>24</sup> Microsoft 365 группы доступны с ограниченными функциональными возможностями.<br/>
<sup>25</sup> подписка на приложения Microsoft 365 для предприятия также необходима для exchange Server 2013 и exchange Server 2016.
