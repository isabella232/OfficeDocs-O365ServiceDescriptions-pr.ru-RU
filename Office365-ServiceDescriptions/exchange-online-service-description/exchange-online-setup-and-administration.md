...
В этом разделе описываются элементы управления Администрирование и поддержку, доступны для настройки параметров Exchange Online и следите потребности организации в среду Exchange Online, запущен, и текущий. Содержит сведения о средства самостоятельного администрирования и возможности, доступные для предприятий. Ответственность за администрирование Microsoft и обязательств производительности; и обновление служб и продуктов.
...
- [Центр администрирования Microsoft Office 365](exchange-online-setup-and-administration.md#microsoft-office-365-admin-center)
