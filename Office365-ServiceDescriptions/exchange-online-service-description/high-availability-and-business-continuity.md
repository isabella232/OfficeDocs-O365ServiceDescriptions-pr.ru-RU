...
Microsoft Exchange Online предлагает расширенную хранения и восстановления поддержка инфраструктуры электронной почты. Этот компонент включает репликации почтовых ящиков в центрах обработки данных и возможность восстановить удаленные почтовые ящики и удаленных элементов.
