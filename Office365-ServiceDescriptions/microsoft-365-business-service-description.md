...
<br/><sup>13</sup> Расширенное обнаружение электронных данных поддерживается в Соединенных Штатах Америки и в регионе Западная Европа (Нидерланды). Данные пользователей из Канады и Азиатско-Тихоокеанского региона экспортируются в Соединенные Штаты. Данные пользователей из Европы, Ближнего Востока и Африки экспортируются в Западную Европу (Нидерланды). <br/><sup>14</sup> доступно в [https://securescore.office.com](https://securescore.office.com). Требуются разрешения администратора. Дополнительные сведения см. [в статье Введение в Office 365 Secure Score](https://go.microsoft.com/fwlink/?linkid=863490).
<br/><sup>15</sup> упрощенное управление устройствами Windows 10, встроенное в Microsoft 365 Business Console. Полные возможности Intune для iOS, Android, MacOS и другие кроссплатформенные функции управления устройствами встроены в консоль Azure, а также лицензируются для использования с Microsoft 365 бизнес. Сторонние приложения и настройка таких элементов, как профили Wi-Fi, VPN-сертификаты и т. д., можно управлять в полной консоли Intune. <br/>
